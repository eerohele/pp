...
(deftest pprint
  ...
  ($ ^:m [:a 1 :b 2] :max-width 22 :print-meta true)
  ($ (with-meta [:a 11] {:b 2}) :print-meta true :max-width 6)
  ;; the discarded forms are cases where clojure.pprint goes into miser mode
  ;; too eagerly
  #_($ (with-meta [:a 11] {:b 2}) :print-meta true :max-width 7)
  ($ (with-meta [:a 11] {:b 2}) :print-meta true :max-width 8)
  ($ (with-meta [:a 11] {:b 2}) :print-meta true :max-width 14)
  ($ (with-meta [:a 11] {:b 2}) :print-meta true :max-width 15)
  ($ (with-meta [:a 11] {:b 2}) :print-meta true :max-width 16)
  ($ (with-meta [:a 11 :b 2] {:c 3}) :print-meta true :max-width 8)
  #_($ (with-meta [:a 11] {:b 2 :c 3}) :print-meta true :max-width 7)
  ($ {:a (with-meta [:b 2] {:c 3})} :max-width 8 :print-meta true)
  ($ {:a (with-meta [:b 2] {:c 3})} :max-width 9 :print-meta true)
  ($ [^{:a 1 :b 2} {:a 1}] :max-width 14 :print-meta true)
  ($ (with-meta [:a 1 :b [:c 2]] {:a 1 :b {:c 2}}) :print-meta true :print-level 1)
  ($ (with-meta [:a 1 :b [:c 2]] {:a 1 :b {:c 2}}) :print-meta true :print-level 2)
  ($ (with-meta [:a 1 :b [:c 2]] {:a 1 :b {:c 2}}) :print-meta true :print-level 3)
  ($ (with-meta [:a 1 :b [:c 2]] {:a 1 :b {:c 2}}) :print-meta true :print-level 4)
  ($ ^:m {:a 1} :max-width 16 :print-meta true)
  ($ ^:m {:a 1 :b 2} :max-width 22 :print-meta true)
  ($ (with-meta {:a 11} {:b 2}) :print-meta true :max-width 6)
  #_($ (with-meta {:a 11} {:b 2}) :print-meta true :max-width 7)
  ...
  ($ (with-meta {:a 11} {:b 2}) :print-meta true :max-width 15)
  ($ (with-meta {:a 11} {:b 2}) :print-meta true :max-width 16)
  #_($ (with-meta {:a 1 :b 2} {:c 3}) :print-meta true :max-width 7)
  #_($ (with-meta {:a 1} {:b 2 :c 3}) :print-meta true :max-width 7)
  ($ {:a (with-meta {:b 2} {:c 3})} :max-width 8 :print-meta true)
  ($ {:a (with-meta {:b 2} {:c 3})} :max-width 9 :print-meta true)
  ($ {^{:a 1 :b 2} {:a 1} {:c 3}} :max-width 14 :print-meta true)
  ($ (with-meta {:a 1 :b {:c 2}} {:a 1 :b {:c 2}}) :print-meta true :print-level 1)
  ($ (with-meta {:a 1 :b {:c 2}} {:a 1 :b {:c 2}}) :print-meta true :print-level 2)
  ($ (with-meta {:a 1 :b {:c 2}} {:a 1 :b {:c 2}}) :print-meta true :print-level 3)
  ($ (with-meta {:a 1 :b {:c 2}} {:a 1 :b {:c 2}}) :print-meta true :print-level 4)
